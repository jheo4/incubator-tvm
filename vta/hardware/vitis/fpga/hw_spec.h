...
/*! from pkg config: closely tighted to hw specs zynq 7000 */
#define VTA_LOG_BUS_WIDTH 6 // log_axi_bus_width
...
#define VTA_LOG_OUT_BUFF_SIZE VTA_LOG_INP_BUFF_SIZE
